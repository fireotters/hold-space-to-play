...
public class MainMenuUi : BaseUi
{
    ...
    void Start()
    {
        ...
        // Load UI Demo videos
        vidUiDemo_3btn.url = System.IO.Path.Combine(Application.streamingAssetsPath, "Demo_3button.webm");
        vidUiDemo_2btn.url = System.IO.Path.Combine(Application.streamingAssetsPath, "Demo_2button.webm");
